...
internal static class FormsExtensions
{
	...
	/// <summary>
	/// Gets an always valid rectangle where right is always greater or equal to left and bottom always greater or equal to top.
	/// </summary>
	...
	public static void DisableDropdownClosingOnClickRecursively(this ToolStripDropDownItem item)
	{
		...
		foreach (ToolStripItem itemDropDownItem in item.DropDownItems)
		{
			...
			menuItem.DisableDropdownClosingOnClickRecursively();
		}
	}
