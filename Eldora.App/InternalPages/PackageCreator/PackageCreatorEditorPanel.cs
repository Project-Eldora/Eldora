...
public partial class PackageCreatorEditorPanel : UserControl
{
	...
	private event EventHandler? EditingChanged;
	...
	// TODO: Add button to add Dependencies
	...
	private void InitializeMetadataEditor()
	{
		...
		//tlpMetadata.RowStyles.Add(new RowStyle(SizeType.Absolute, 20));
		//tlpMetadata.Controls.Add(title, 0, tlpMetadata.RowCount);
		//tlpMetadata.Controls.Add(valueR, 1, tlpMetadata.RowCount);
